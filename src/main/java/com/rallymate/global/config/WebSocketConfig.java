...
/**
 * STOMP WebSocket 설정을 담당합니다.
 * <p>
 * - 클라이언트는 {@code /api/v1/connect} 엔드포인트로 연결합니다.
 * - 서버 수신 prefix는 {@code /pub}, 사용자별 큐는 {@code /user/queue}를 사용합니다.
 * </p>
 */
@Configuration
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        registry.enableSimpleBroker("/sub", "/queue");  // 1:1(queue), 1:N(sub)
